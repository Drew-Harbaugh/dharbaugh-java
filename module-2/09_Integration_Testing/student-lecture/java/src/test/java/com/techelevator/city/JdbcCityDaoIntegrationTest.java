...
public class JdbcCityDaoIntegrationTest {
	...
	public void new_city_can_be_created_and_retrieved(){
		...
		//Act
		sut.create(testCity);
		City retrieveCity = sut.findCityById(testCity.getId());

		//Assert
		assertCitiesAreEqual(testCity, retrieveCity);
	}
	...
	@Test
	public void all_cities_for_country_code_are_found(){
		//Arrange
		for (int i = 0; i < 100; i++) {
			City testCity = createTestCity();
