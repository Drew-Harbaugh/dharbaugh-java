...
VALUES ('USA', 'Klingon', false, 0.000001);
...
VALUES ('Klingon', false, 0.000001, 'GBR');
...
VALUES ('Elvish', true, 50);            ----FAILS TO INSERT

-- 2. Try inserting English as a spoken language in the country ZZZ. What happens?

INSERT INTO countrylanguage (countrycode, language, isofficial, percentage)
VALUES ('ZZZ', 'English', false, 50);     ----FAILS TO INSERT

-- 3. Try deleting the country USA. What happens?

DELETE FROM country WHERE code = 'USA';         ------FAILS TO DELETE
