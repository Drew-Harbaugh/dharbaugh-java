<template>
    <div class="main">
        ...
        <div class="well-display">
            ...
            <div class="well">
                <span class="amount">{{ countReviews(3) }}</span>
                3 Star Review
            </div>

            <div class="well">
                <span class="amount">{{ countReviews(4) }}</span>
                4 Star Review
            </div>

            <div class="well">
                <span class="amount">{{ countReviews(5) }}</span>
                5 Star Review
            </div>
        </div>

        <div class="review" v-bind:class="review.favorite? 'favorited':''" v-for="review in reviews" v-bind:key="review.id">
