<template>
  <div class="main" v-on:click="description = 'click in main'">
    ...
    <a href="#" v-on:click.prevent="showForm = true" v-if="!showForm"
      >Show Form</a
    >
    <a href="#" v-on:click.prevent="showForm = false" v-if="showForm"
      >Hide Form</a
    >
    <form v-on:submit.prevent="addNewReview()" v-show="showForm">
      ...
      <div class="form-element">
        ...
        <textarea id="review" v-model="newReview.reiew"></textarea>
      </div>
  ...
  computed: {
    ...
    filteredReviews() {
      return this.reviews.filter(
        (review) =>
          this.ratingFilter === 0 || review.rating === this.ratingFilter
      );
    },
  },
  methods: {
