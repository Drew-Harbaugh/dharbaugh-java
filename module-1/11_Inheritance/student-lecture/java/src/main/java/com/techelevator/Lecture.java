...
public class Lecture {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("The high bidder on " + firstAuction.getItemForSale()
                + " is " + firstAuction.getHighBid().getBidder());
        ...
        System.out.println("The high bidder on " + secondAuction.getItemForSale()
                + " is " + secondAuction.getHighBid().getBidder());
        ...
        System.out.println("The high bidder on " + thirdAuction.getItemForSale()
                + " is " + thirdAuction.getHighBid().getBidder());
